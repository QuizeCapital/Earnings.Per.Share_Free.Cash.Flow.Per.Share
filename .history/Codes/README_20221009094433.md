...
and gets eps, fcfpcs, price, fcf, and earnnings surpise data from the income statement section as bulk data. Takes original ticker data as parameter and returns returns each tickers data with limit of 7 years.
