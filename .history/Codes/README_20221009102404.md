...
The 'arrayOfFCFPSbyEps' function creates merged 5 quintiles containing intersection of securites based in their eps and free cash flow per share. It takes dataframe of free cash flow and eps as parameter. It returns a dict of number (descending percentage change) as key and list of tickers for that quintle as value
