...
The 'fcfpsPctChange' This function calculates the percentage change in free cash flow per share of our universeIt takes a dictionary of symbol, date and free cash flow per share as inputs
