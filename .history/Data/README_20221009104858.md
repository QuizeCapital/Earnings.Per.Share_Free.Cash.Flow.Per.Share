...
The Log Returns Data.json file (/Users/adamszequi/Desktop/Clones/EPS.FCFPS/Data/Log Returns Data.json) contains contains columns of Ticker Name and free cash flow per share as a dictionary  in the format{{key:}key:value}.
